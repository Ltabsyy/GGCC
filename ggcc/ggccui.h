	...
	namespace ui {
		...
		namespace highlight {
			...
			Color color_one_dark[17] = {
				...
				Color{255, 255, 255, 255},	//行号
				Color{255, 255, 255, 255},	//当前行号
			...
			std::string Theme = "One Dark";	// 当前配色
			
			// 根据当前配色获取颜色
			Color GetColor(int type) {
				if(Theme == "One Dark")return color_one_dark[type];
			}
